...
export function Footer() {
  return (
    <footer id="contact" className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Contact Section */}
        <div className="mb-12 text-center">
          <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-[#00A878] to-[#00c98c] bg-clip-text text-transparent">
            Get in Touch
          </h3>
