    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-[#00A878]/5 to-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden hover:shadow-3xl hover:scale-[1.02] transition-all duration-500">
            {/* Dashboard Header */}
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-[#00A878]/10 via-white to-[#00c98c]/5 rounded-xl p-6 border border-[#00A878]/20 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer relative overflow-hidden">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                {/* Bar Chart Mockup */}
                <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
